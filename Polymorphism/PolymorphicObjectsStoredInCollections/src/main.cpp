#include <iostream>
#include <memory>  // related to smart pointers
...
int main() {
  ...
  */
  ...
  // What if we store in references? Compiler error : references aren't left
  // assignable const Shape& shapes2[]
  // {circle1,oval1,circle2,oval2,circle3,oval3};
  ...
  /*
     ...
     sizeof(*shape_ptr) << std::endl; shape_ptr->draw(); std::cout << std::endl;
      }
  */
